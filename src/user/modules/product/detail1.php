...
$book_detail = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM `book`, publisher, discount  WHERE book.book_id = '{$book_id}' and book.publisher_id = publisher.publisher_id and book.discount_id = discount.discount_id"));
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  ...
                  <div class="sale-offer-tag"><span><?= $book_detail['discount_name']?><br>
                    off</span></div>
