...
$top_selling_list = db_fetch_array("SELECT book.book_id, book.book_name, book.book_price as current_price ,SUM(orderdetail.quantity) as sold ,SUM(orderdetail.book_price*orderdetail.quantity) as revenue FROM book, orderdetail WHERE book.book_id = orderdetail.book_id GROUP BY book.book_id ORDER BY `sold` DESC");
