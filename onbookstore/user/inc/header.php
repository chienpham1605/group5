                  ...
                  <div class="cart-item product-summary">
                    ...
                    if (mysqli_num_rows($list_cart) == 0):
                      ...
                      while ($item = mysqli_fetch_assoc($list_cart)):
                        ...
                        <div class="row">
                          <div class="col-xs-4">
                            <div class="image"> <a href="detail.html"><img src="public/assets/images/products/p4.jpg"
                                  alt=""></a> </div>
                          </div>
                          <div class="col-xs-7">
            ...
            <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                  <li class="active dropdown"> <a href="?mod=home&act=main">Home</a> </li>
                  <li class="dropdown yamm mega-menu"> <a href="home.html" data-hover="dropdown" class="dropdown-toggle"
                      data-toggle="dropdown">Signed Books</a>
                        ...
                        <div class="yamm-content ">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive"
                                src="public/assets/images/banners/top-menu-banner.jpg" alt=""> </div>
                            <!-- /.yamm-content -->
                          </div>
                        </div>
                      </li>
                  ...
                  <li class="dropdown mega-menu">
                    <a href="category.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Hot
                      Deals <span class="menu-label hot-menu hidden-xs">hot</span> </a>
                    <ul class="dropdown-menu container">
                      <li>
                        <div class="yamm-content">
                          <div class="row">
                  ...
                  <li class="dropdown hidden-sm"> <a href="category.html">New Arrivals<span
                        class="menu-label new-menu hidden-xs">new</span> </a> </li>
                  <li class="dropdown hidden-sm"> <a href="category.html">Coming Soon</a> </li>
                  <li class="dropdown"> <a href="contact.html">Best Seller</a> </li>
                  <li class="dropdown"> <a href="contact.html">NYT Best Seller</a> </li>
