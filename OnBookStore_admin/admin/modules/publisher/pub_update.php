            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  ...
                  <input class="form-control" type="file" name="txtLogo" value="<?= $fields[1] ?>">
                </div>
                <div class="col-12">
                  <label class="form-label">Website</label>
                  <input class="form-control" name="txtLinkWeb" value="<?= $fields[2] ?>">
                  <span class="error"> <?php echo $urlErr; ?></span>
                </div>
                <div class="col-12">
                  <label class="form-label">Phone</label>
                  <input type="text" name="txtPhone" value="<?= $fields[3] ?>" class="form-control">
                  <span class="error"> <?php echo $phoneErr; ?></span>
                </div>
                <div class="col-12">
                  <label class="form-label">Email</label>
                  <input type="text" class="form-control" name="txtEmail" value="<?= $fields[4] ?>">
                  <span class="error"> <?php echo $emailErr; ?></span>
                </div>
                <div class="col-12">
                  <label class="form-label">Address</label>
                  <input type="text" class="form-control"  name="txtAddress" value="<?= $fields[5] ?>">
                </div>
